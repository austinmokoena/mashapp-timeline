    ...
    public class AdapterBind
    {
        ...
        public void HeaderPostBind(AdapterHolders.PostTopSectionViewHolder holder, AdapterModelsClass item)
        {
            try
            {
                ...
                var glideRequestOptions2 = new RequestOptions().SkipMemoryCache(true).CenterCrop().CircleCrop().Format(DecodeFormat.PreferRgb565)
                    ...
                    .Error(ResourceConstant.Drawable.ImagePlacholder_circle)
                    .Placeholder(ResourceConstant.Drawable.ImagePlacholder_circle);
                ...
                switch (item.PostData.PostPrivacy)
                {
                    //Anonymous Post
                    case "4":
                        holder.Username.Text = ActivityContext.GetText(ResourceConstant.String.Lbl_Anonymous);
                        break;
                    default:
                ...
                if (holder.PrivacyPostIcon != null && !string.IsNullOrEmpty(item.PostData.PostPrivacy) && (publisher.UserId == UserDetails.UserId || AppSettings.ShowPostPrivacyForAllUser))
                {
                    switch (item.PostData.PostPrivacy)
                    {
                        //Everyone
                        case "0":
                            holder.PrivacyPostIcon.SetImageResource(ResourceConstant.Drawable.icon_post_global_vector);
                            break;
                        default:
                            {
                                if (item.PostData.PostPrivacy.Contains("ifollow") || item.PostData.PostPrivacy == "2") //People_i_Follow
                                {
                                    holder.PrivacyPostIcon.SetImageResource(ResourceConstant.Drawable.ic_friend);
                                }
                                else if (item.PostData.PostPrivacy.Contains("me") || item.PostData.PostPrivacy == "1") //People_Follow_Me
                                {
                                    holder.PrivacyPostIcon.SetImageResource(ResourceConstant.Drawable.ic_users);
                                }
                                else switch (item.PostData.PostPrivacy)
                                {
                                    //Anonymous
                                    case "4":
                                        holder.PrivacyPostIcon.SetImageResource(ResourceConstant.Drawable.ic_detective);
                                        break;
                                    //No_body 
                                    default:
                                        holder.PrivacyPostIcon.SetImageResource(ResourceConstant.Drawable.ic_lock);
                                        break;
                                }
        ...
        public void SharedHeaderPostBind(AdapterHolders.PostTopSharedSectionViewHolder holder, AdapterModelsClass item)
        {
            try
            {
                ...
                {
                    //Anonymous Post
                    "4" => ActivityContext.GetText(ResourceConstant.String.Lbl_Anonymous),
        ...
        public void PrevBottomPostPartBind(AdapterHolders.PostPrevBottomSectionViewHolder holder, AdapterModelsClass item)
        {
            try
            {
                if (holder.CommentCount != null)
                    holder.CommentCount.Text = item.PostData.PostComments + " " + ActivityContext.GetString(ResourceConstant.String.Lbl_Comments);

                if (AppSettings.ShowTextShareButton)
                {
                    if (holder.ShareCount != null)
                        holder.ShareCount.Text = item.PostData.DatumPostShare + " " + ActivityContext.GetString(ResourceConstant.String.Lbl_Shares);
                }
                else
                {
                    if (holder.ShareCount != null)
                ...
                if (holder.LikeCount != null)
                {
                    switch (AppSettings.PostButton)
                    {
                        case PostButtonSystem.Reaction:
                            holder.LikeCount.Text = item.PostData.PostLikes + " " + ActivityContext.GetString(ResourceConstant.String.Lbl_Reactions);
                            break;
                        default:
                            holder.LikeCount.Text = item.PostData.PostLikes + " " + ActivityContext.GetString(ResourceConstant.String.Btn_Likes);
                            break;
                    }
                }
                    ...
                    case PostButtonSystem.Reaction:
                        {
                            ...
                            if (item.PostData.Reaction.Count > 0)
                                holder.ImageCountLike.SetImageResource(ResourceConstant.Drawable.emoji_like);
                            else
                                holder.ImageCountLike.SetImageResource(ResourceConstant.Drawable.icon_post_like_vector);
                                    ...
                                    case false:
                                        {
                                            ...
                                            switch (react)
                                            {
                                                case "1":
                                                    ...
                                                    break;
                                                case "2":
                                                    holder.ImageCountLike.SetImageResource(ResourceConstant.Drawable.emoji_love);
                                                    break;
                                                case "3":
                                                    holder.ImageCountLike.SetImageResource(ResourceConstant.Drawable.emoji_haha);
                                                    break;
                                                case "4":
                                                    holder.ImageCountLike.SetImageResource(ResourceConstant.Drawable.emoji_wow);
                                                    break;
                                                case "5":
                                                    holder.ImageCountLike.SetImageResource(ResourceConstant.Drawable.emoji_sad);
                                                    break;
                                                case "6":
                                                    holder.ImageCountLike.SetImageResource(ResourceConstant.Drawable.emoji_angry);
                                                    break;
                                                default:
                            ...
                            if (holder.SecondReactionButton != null)
                            {
                                switch (AppSettings.PostButton)
                                {
                                    case PostButtonSystem.Wonder when item.PostData.IsWondered != null && item.PostData.IsWondered.Value:
                                        {
                                            Drawable unwrappedDrawable = AppCompatResources.GetDrawable(ActivityContext, ResourceConstant.Drawable.icon_post_wonder_vector);
                                            ...
                                            holder.SecondReactionButton.Text = ActivityContext.GetString(ResourceConstant.String.Lbl_wondered);
                                    ...
                                    case PostButtonSystem.Wonder:
                                        {
                                            ...
                                            holder.SecondReactionButton.Text = ActivityContext.GetString(ResourceConstant.String.Btn_Wonder);
                                    ...
                                    case PostButtonSystem.DisLike when item.PostData.IsWondered != null && item.PostData.IsWondered.Value:
                                        {
                                            Drawable unwrappedDrawable = AppCompatResources.GetDrawable(ActivityContext, ResourceConstant.Drawable.icon_post_dislike_vector);
                                            Drawable wrappedDrawable = DrawableCompat.Wrap(unwrappedDrawable);
                                            ...
                                            holder.SecondReactionButton.Text = ActivityContext.GetString(ResourceConstant.String.Lbl_disliked);
                                    ...
                                    case PostButtonSystem.DisLike:
                                        {
                                            ...
                                            holder.SecondReactionButton.Text = ActivityContext.GetString(ResourceConstant.String.Btn_Dislike);
                                            holder.SecondReactionButton.SetTextColor(Color.ParseColor("#444444"));
                                            break;
                                        }
                                }
                ...
                else
                {
                    ...
                    if (item.PostData.RegexFilterList != null & item.PostData.RegexFilterList?.Count > 0)
                    {
                        foreach (var user in item.PostData.RegexFilterList)
                        {
                            ...
                            spendable.SetSpan(new PostTextMentionsClickSpanClass(user.Key, holder), indexFrom, indexLast, SpanTypes.ExclusiveExclusive);
                        }
                    }
                    ...
                    if (AppSettings.TextSizeDescriptionPost == WRecyclerView.VolumeState.On)
                    {
                        ...
                        {
                            if (item.PostData.Orginaltext.Contains("http") || item.PostData.Orginaltext.Contains(ActivityContext.GetText(ResourceConstant.String.Lbl_ReadMore)) || item.PostData.Orginaltext.Contains(ActivityContext.GetText(ResourceConstant.String.Lbl_ReadLess)))
        ...
        private class PostTextMentionsClickSpanClass : ClickableSpan
        {
            private readonly NativePostAdapter PostAdapter;
            private readonly PostClickListener PostClickListener;
            private readonly AdapterHolders.PostTextSectionViewHolder ViewHolder;
            private readonly string UserId;

            public PostTextMentionsClickSpanClass(string userId, AdapterHolders.PostTextSectionViewHolder viewHolder)
            {
                try
                {
            ...
            public override void OnClick(View widget)
            {
                try
                {
                    WoWonderTools.OpenProfile(PostAdapter.ActivityContext, UserId, null);
                }
                catch (Exception e)
                {
                    Methods.DisplayReportResultTrack(e);
        ...
        public void LoadCommentData(CommentObjectExtra item, RecyclerView.ViewHolder viewHolder)
        {
            try
            {
                ...
                if (AppSettings.FlowDirectionRightToLeft)
                    holder.UserName.SetCompoundDrawablesWithIntrinsicBounds(item.Publisher.Verified == "1" ? ResourceConstant.Drawable.icon_checkmark_small_vector : 0, 0, 0, 0);
                else
                    holder.UserName.SetCompoundDrawablesWithIntrinsicBounds(0, 0, item.Publisher.Verified == "1" ? ResourceConstant.Drawable.icon_checkmark_small_vector : 0, 0);
                ...
                if (repliesCount != "0" && !string.IsNullOrEmpty(repliesCount))
                    holder.ReplyTextView.Text = ActivityContext.GetText(ResourceConstant.String.Lbl_Reply) + " " + "(" + repliesCount + ")";
                                    ...
                                    case false:
                                        {
                                            ...
                                            switch (react)
                                            {
                                                ...
                                                case "6":
                                                    ...
                                                    break;
                                                default:
                                                    holder.LikeTextView.Text = ActivityContext.GetText(ResourceConstant.String.Btn_Like);
                    ...
                    default:
                        {
                            ...
                            {
                                case true:
                                    holder.LikeTextView.Text = ActivityContext.GetText(ResourceConstant.String.Btn_Liked);
        ...
        public void ImagePostBind(AdapterHolders.PostImageSectionViewHolder holder, AdapterModelsClass item)
        {
            try
            {
                ...
                if (imageUrl.Contains(".gif"))
                    Glide.With(ActivityContext?.BaseContext).Load(imageUrl).Apply(new RequestOptions().Placeholder(ResourceConstant.Drawable.ImagePlacholder)).Into(holder.Image);
                else
        ...
        public void EventPostBind(AdapterHolders.EventPostViewHolder holder, AdapterModelsClass item)
        {
            try
            {
                if (item.PostData.Event?.EventClass != null)
                {
                    ...
                    holder.TxtEventGoing.Text = item.PostData?.Event?.EventClass?.GoingCount + " " + ActivityContext.GetText(ResourceConstant.String.Lbl_GoingPeople);
                }
            }
            catch (Exception e)
            {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (item.PostData.PostLink.Contains("facebook.com") || item.PostData.PostLinkImage.Contains("facebook.png"))
                        loader.Load(item.PostData.PostLinkImage).Error(ResourceConstant.Drawable.facebook).Placeholder(ResourceConstant.Drawable.facebook);
                    else if (item.PostData.PostLink.Contains("vimeo.com") || item.PostData.PostLinkImage.Contains("vimeo.png"))
                        loader.Load(ResourceConstant.Drawable.vimeo).Error(ResourceConstant.Drawable.vimeo).Placeholder(ResourceConstant.Drawable.vimeo);
                    else if (item.PostData.PostLinkImage.Contains("default_video_thumbnail.png"))
                        loader.Load(ResourceConstant.Drawable.default_video_thumbnail).Error(ResourceConstant.Drawable.default_video_thumbnail).Placeholder(ResourceConstant.Drawable.default_video_thumbnail);
                    else
        ...
        public void AgoraLivePostBind(AdapterHolders.PostAgoraLiveViewHolder holder, AdapterModelsClass item)
        {
            try
            {
                ...
                {
                    holder.TxtName.Text = WoWonderTools.GetNameFinal(item.PostData.Publisher) + " " + ActivityContext.GetText(ResourceConstant.String.Lbl_StartedBroadcastingLive);
                }
                else
                {
                    holder.TxtName.Text = WoWonderTools.GetNameFinal(item.PostData.Publisher) + " " + ActivityContext.GetText(ResourceConstant.String.Lbl_StreamHasEnded);
                }
            }
            catch (Exception e)
            {
                    ...
                    case PostModelType.FacebookPost:
                        {
                            ...
                            if (item.PostData.PostFacebook.Contains("https://fb.watch"))
                                content = "<iframe src='https://www.facebook.com/plugins/video.php?href=" + item.PostData.PostFacebook + "&show_text=false&appId=" + ActivityContext.GetText(ResourceConstant.String.facebook_app_id) + "&height=600&show_text=false'";
                            else if (item.PostData.PostFacebook.Contains("https://www.facebook.com"))
                                content = "<iframe src='https://www.facebook.com/plugins/video.php?href=" + item.PostData.PostFacebook + "&show_text=false&appId=" + ActivityContext.GetText(ResourceConstant.String.facebook_app_id) + "&height=600&show_text=false'";
                            else
                                content = "<iframe src='https://www.facebook.com/plugins/video.php?href=https://fb.watch/" + item.PostData.PostFacebook + "&show_text=false&appId=" + ActivityContext.GetText(ResourceConstant.String.facebook_app_id) + "&height=600&show_text=false'";
        ...
        public void JobPostSectionBind(AdapterHolders.JobPostViewHolder holder, AdapterModelsClass item)
        {
            try
            {
                if (item.PostData.Job != null)
                {
                    ...
                    {
                        //Set job type
                        "full_time" => ActivityContext.GetString(ResourceConstant.String.Lbl_full_time),
                        "part_time" => ActivityContext.GetString(ResourceConstant.String.Lbl_part_time),
                        "internship" => ActivityContext.GetString(ResourceConstant.String.Lbl_internship),
                        "volunteer" => ActivityContext.GetString(ResourceConstant.String.Lbl_volunteer),
                        "contract" => ActivityContext.GetString(ResourceConstant.String.Lbl_contract),
                        _ => ActivityContext.GetString(ResourceConstant.String.Lbl_Unknown)
                    ...
                    if (item.PostData.Job.Value.JobInfoClass.ButtonText.Contains(ActivityContext.GetString(ResourceConstant.String.Lbl_show_applies)))
                    {
                        holder.JobButton.Tag = "ShowApply";
                    }
                    else if (item.PostData.Job.Value.JobInfoClass.ButtonText.Contains(ActivityContext.GetString(ResourceConstant.String.Lbl_already_applied)))
                    {
                        holder.JobButton.Enabled = false;
                    }
                    else if (item.PostData.Job.Value.JobInfoClass.ButtonText.Contains(ActivityContext.GetString(ResourceConstant.String.Lbl_apply_now)))
                    {
                    ...
                    case false when item.PostData.VotedId != "0":
                        {
                            ...
                            {
                                holder.CheckIcon.SetImageResource(ResourceConstant.Drawable.icon_checkmark_filled_vector);
                                holder.CheckIcon.ClearColorFilter();
                                holder.ProgressText.SetTextColor(new Color(ContextCompat.GetColor(holder.VoteText.Context, ResourceConstant.Color.primary)));
                                holder.ProgressBarView.ProgressDrawable = ContextCompat.GetDrawable(holder.ProgressBarView.Context, ResourceConstant.Drawable.primary_progress);
                            }
                            else
                            {
                                holder.CheckIcon.SetImageResource(ResourceConstant.Drawable.icon_check_circle_vector);
        ...
        public void AlertJoinBoxBind(AdapterHolders.AlertJoinAdapterViewHolder holder, AdapterModelsClass item)
        {
            try
            {
                ...
                {
                    case "Groups":
                        holder.MainRelativeLayout.SetBackgroundResource(ResourceConstant.Drawable.Shape_Gradient_Linear);
                        holder.ButtonView.Text = ActivityContext.GetString(ResourceConstant.String.Lbl_FindYourGroups);
                        break;
                    case "Pages":
                        holder.MainRelativeLayout.SetBackgroundResource(ResourceConstant.Drawable.Shape_Gradient_Linear1);
                        holder.ButtonView.Text = ActivityContext.GetString(ResourceConstant.String.Lbl_FindPopularPages);
                        break;
                }
            }
            catch (Exception e)
                ...
                if (item.InfoUserModel.UserData != null)
                {
                    if (item.InfoUserModel.UserData.IsPro == "1")
                    {
                        ...
                        if (!string.IsNullOrEmpty(type))
                        {
                            if (type == "star")
                            {
                                holder.ProText.Text = ActivityContext.GetText(ResourceConstant.String.Lbl_Star) + " " + ActivityContext.GetText(ResourceConstant.String.Lbl_Member);
                            }
                            else if (type == "hot")
                            {
                                holder.ProText.Text = ActivityContext.GetText(ResourceConstant.String.Lbl_Hot) + " " + ActivityContext.GetText(ResourceConstant.String.Lbl_Member);
                            }
                            else if (type == "ultima")
                            {
                                holder.ProText.Text = ActivityContext.GetText(ResourceConstant.String.Lbl_Ultima) + " " + ActivityContext.GetText(ResourceConstant.String.Lbl_Member);
                            }
                            else if (type == "vip")
                            {
                                holder.ProText.Text = ActivityContext.GetText(ResourceConstant.String.Lbl_Vip) + " " + ActivityContext.GetText(ResourceConstant.String.Lbl_Member);
                            }
                            else
                            {
                                holder.ProText.Text = type.ToUpper() + " " + ActivityContext.GetText(ResourceConstant.String.Lbl_Member);
                            }
                        }
                        else
                            holder.ProText.Text = ActivityContext.GetText(ResourceConstant.String.Lbl_ProMember);
                    }
                    else
                    {
                    ...
                    switch (ListUtils.SettingsSiteList?.Genders?.Count)
                    {
                        ...
                        default:
                            {
                                if (item.InfoUserModel.UserData.Gender == ActivityContext.GetText(ResourceConstant.String.Radio_Male))
                                {
                                    holder.GanderText.Text = ActivityContext.GetText(ResourceConstant.String.Radio_Male);
                                }
                                else if (item.InfoUserModel.UserData.Gender == ActivityContext.GetText(ResourceConstant.String.Radio_Female))
                                {
                                    holder.GanderText.Text = ActivityContext.GetText(ResourceConstant.String.Radio_Female);
                                }
                                else
                                {
                    ...
                    {
                        case false:
                            holder.WorkText.Text = ActivityContext.GetText(ResourceConstant.String.Lbl_WorkingAt) + " " + item.InfoUserModel.UserData.Working;
                        ...
                        case false when item.InfoUserModel.UserData.CountryId != "0":
                            {
                                ...
                                holder.LiveText.Text = ActivityContext.GetText(ResourceConstant.String.Lbl_LivingIn) + " " + countryName;
                    ...
                    {
                        case false:
                            holder.StudyText.Text = ActivityContext.GetText(ResourceConstant.String.Lbl_StudyingAt) + " " + item.InfoUserModel.UserData.School;
        ...
        public void InfoGroupBoxBind(AdapterHolders.InfoGroupBoxViewHolder holder, AdapterModelsClass item)
        {
            try
            {
                if (item.PrivacyModelClass?.GroupClass != null)
                {
                    ...
                    holder.PrivacyText.Text = ActivityContext.GetText(item.PrivacyModelClass?.GroupClass.Privacy == "1" ? ResourceConstant.String.Radio_Public : ResourceConstant.String.Radio_Private);
                    holder.IconPrivacy.SetImageResource(item.PrivacyModelClass?.GroupClass.Privacy == "1" ? ResourceConstant.Drawable.icon_post_global_vector : ResourceConstant.Drawable.ic_lock);

                    if (item.PrivacyModelClass.GroupClass.Members != 0)
                        holder.TxtMembers.Text = Methods.FunString.FormatPriceValue(item.PrivacyModelClass.GroupClass.Members) + " " + ActivityContext.GetString(ResourceConstant.String.Lbl_Members);
                    else if (item.PrivacyModelClass.GroupClass.MembersCount != null && item.PrivacyModelClass.GroupClass.MembersCount.Value != 0)
                        holder.TxtMembers.Text = Methods.FunString.FormatPriceValue(item.PrivacyModelClass.GroupClass.MembersCount.Value) + " " + ActivityContext.GetString(ResourceConstant.String.Lbl_Members);
                }
            }
            catch (Exception e)
            {
                ...
                switch (dataOwner)
                {
                    case null:
                        holder.StoryAdapter.StoryList.Insert(0, new StoryDataObject
                        {
                            ...
                            Type = "Your",
                            Username = ActivityContext.GetText(ResourceConstant.String.Lbl_YourStory),
        ...
        public void AdsPostBind(AdapterHolders.AdsPostViewHolder holder, AdapterModelsClass item)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (!holder.Description.Text.Contains(ActivityContext.GetText(ResourceConstant.String.Lbl_ReadMore)) && !holder.Description.Text.Contains(ActivityContext.GetText(ResourceConstant.String.Lbl_ReadLess)))
                    {
                        switch (item.PostData.RegexFilterList != null & item.PostData.RegexFilterList?.Count > 0)
                        {
                            case true:
