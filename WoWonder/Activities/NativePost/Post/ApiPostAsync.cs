                            ...
                            case > 0:
                                {
                                    ...
                                    //foreach (var user in item.RegexFilterList)
                                    //{
                                    //    string fullName = item.MentionsUsers.MentionsUsersList?.FirstOrDefault(a => a.Key == user.Value?.Replace("/", "")).Value;
                                    //    item.Orginaltext = item.Orginaltext.Replace("@" + user.Value, fullName);
                                    //}
